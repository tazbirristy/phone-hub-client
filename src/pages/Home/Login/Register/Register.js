            ...
            >
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-md border-gray-500 dark:bg-gray-800 dark:text-gray-100 focus:border-violet-600"
                  required
                />
              </div>
              <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 32 32"
                  className="w-7 h-7 fill-current text-gray-200 hover:text-indigo-600"
                >
