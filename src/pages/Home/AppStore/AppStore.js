    ...
    <section className="py-6 dark:bg-gray-800 text-purple-50 mt-3">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
          ...
          >
            <button className="inline-flex items-center px-6 py-3 rounded-lg bg-primary text-white">
              <svg
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="inline-flex items-center px-5 py-3 rounded-lg bg-primary text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
                className="fill-current w-7 h-7 dark:text-gray-900"
