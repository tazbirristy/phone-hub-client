    ...
    <div>
        ...
        <div className="max-w-7xl px-10 py-6 mx-auto rounded-lg shadow-sm border-8 border-primary bg-gray-800">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              to="/"
              className="px-2 py-1 font-bold rounded dark:bg-primary dark:text-gray-50"
            >
              React
            </Link>
          </div>
          <div className="mt-3">
            <h2 className="text-2xl font-bold hover:underline text-primary">
            ...
            <p className="mt-2">
              ...
              The id of the current item, being viewed, Filter parameters,
              Pagination offset and limit, Sorting data <br />
              ...
              URL as required when the settings change
              <br />
              <br />
              --Web Storage <br />
              ...
              IndexedDB. These are native browser technologies. Data persisted
              in the browser is tied to a single browser. So, if the user loads
              the site in a different browser, the data will not be available.
              We avoid storing sensitive data in the browser since the user may
              access the app on a shared machine. Some examples of where web
              storage might be most useful include storing a user’s shopping
              cart, saving partially completed form data or storing JWT token in
              HttpOnly Cookie.
              <br /> <br />
              --Local State <br />
              The third option is to use store state locally. It is useful when
              one component needs the state.
              <br />
              <br />
              --Lifted State <br />
              ...
              child components via props. This pattern should be considered any
              time a few related components need to use the same state. The
              lifting state avoids duplicating states in multiple components. It
              helps to assure that our components all consistently reflect the
              same state.
            </p>
          </div>
        </div>
      ...
      <div className="dark:bg-gray-50 dark:text-gray-100 my-12 text-justify">
        <div className="max-w-7xl px-10 py-6 mx-auto rounded-lg shadow-sm border-8 border-primary bg-gray-800">
          ...
          <div className="mt-3">
            <h2 className="text-2xl text-primary font-bold hover:underline">
        ...
        <div className="max-w-7xl px-10 py-6 mx-auto rounded-lg shadow-sm border-8 border-primary bg-gray-800">
          ...
          <div className="mt-3">
            ...
            <p className="mt-2">
              ...
              function or component for a given input.
              <br />
              For React components, this could mean checking that the component
              renders correctly for the specified props.
              <br />
              In other words, writing unit tests means that we write code that
              verifies that our code works as expected. We'll go over the other
              goals of unit testing later on.
              <br />
              <br />
              These are valid points, but I found that the main advantage of
              writing unit tests is how it improves the way you write code. If
              you write your tests during or even before implementing a feature,
              it gives you a better picture of the requirements. You
              automatically end up writing code that's easy to test, loosely
              coupled, and easier to reason about. I first read about this way
              of thinking about tests in The Pragmatic Programmer by David
              Thomas and Andrew Hunt. I didn't know this when I started writing
              my first unit tests, but in retrospect, that's exactly what
              happened. When I started writing tests for some of the legacy code
              at my company, it was never only writing tests. It always went
              hand in hand with refactoring quite a bit of the code, so that it
              would be easier to test it in the first place. For example, I'd
              extract functions from components into a separate file to make
              this code easier to test. This naturally resulted in less coupled
              code.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl px-10 py-6 mx-auto rounded-lg shadow-sm border-8 border-primary bg-gray-800">
          ...
          <div className="mt-3">
            ...
            <p className="mt-2">
              ...
              using React with just a few lines of code.React can be used as a
              UI library to render elements, without enforcing a specific
              project structure, and that’s why it’s not strictly a framework.
              ...
              to the user. React is based on JavaScript, but it’s mostly
              combined with JSX (JavaScript XML), a syntax extension that allows
              you to create elements that contain HTML and JavaScript at the
              same time. Anything you create with JSX could also be created with
              the React JavaScript API, but most developers prefer JSX because
              it’s more intuitive.
              <br /> <br />
              --Vue <br />
